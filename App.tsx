    ...
    <div className="min-h-screen pb-12 transition-colors duration-500">
      ...
      <nav className={`border-b ${isDark ? 'border-white/5 bg-[#000033]/80' : 'border-slate-200 bg-white/90'} backdrop-blur-xl sticky top-0 z-50 transition-all`}>
        <div className="max-w-[1400px] mx-auto px-6 h-24 flex items-center justify-between">
          <img src="/logo.svg" alt="Oficina do Futuro Logo" className="h-12 w-auto object-contain" />
      ...
      <main className="max-w-[1400px] mx-auto px-6 mt-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8">
            <div className="mb-6 flex items-end justify-between border-b pb-4 border-white/5">
              <div className="space-y-1">
                <span className="text-[10px] font-black uppercase text-[#00cc44] tracking-[0.3em]">Canvas Digital</span>
                <h2 className={`text-2xl font-black ${isDark ? 'text-white' : 'text-[#000033]'}`}>RESULTADOS DA GERAÇÃO</h2>
              </div>
      ...
      <footer className="mt-24 py-16 border-t border-white/5 flex flex-col items-center gap-6">
        <img src="/logo.svg" alt="Oficina do Futuro Logo" className="h-8 w-auto object-contain grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-300" />
